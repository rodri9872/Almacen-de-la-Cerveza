...
urlpatterns = [
    path ('articulos_inicio/', views.index, name='articulos'),
    ...
    path('modificar_articulo/<int:articulo_id>/', views.modificar_articulo, name='modificar_articulo'),
    ...
    path('sesion-cerrar', views.cerrar_sesion, name='sesion-cerrar'),
    path('listar_pedido', views.listar_pedidos, name='listar_pedidos'),
    path('vista-pedidos-cocina/', views.vista_pedidos_cocina, name='vista_pedidos_cocina'),
    path('vista-pedidos-cocina-json/', views.vista_pedidos_cocina_json, name='vista_pedidos_cocina_json'),
    ...
    path('comprobante-pedido/<int:pedido_id>/', views.comprobante_pedido, name='comprobante_pedido'),
    path('obtener_detalles_pedido/<int:pedido_id>/', views.obtener_detalles_pedido, name='obtener_detalles_pedido'),
    path('', views.inicio, name='inicio'),
    path('usuarios/', views.listar_usuarios, name='listar_usuarios'),
    path('usuarios/editar/<int:id>/', views.editar_perfil, name='editar_perfil'),
